...
public class StudentService {
    ...
    public Student matriculate(Student s) {
        ...
        try {
            ...
            IList<Integer> student_id = hazel.getList("student_id");
            ...
            if(student_id.isEmpty()){
                ...
                Integer studentId = student_id.get(student_id.size()-1);
            ...
            IMap<Integer, Student> students = hazel.getMap("students");
